  ...
  <div class="peoplepackage">
    ...
    >
      <div slot="right" class="setIcon" style="padding-top: 16px;" @click="create">
        <img src="./imgs/setting.png" alt width="25">
      </div>
    ...
    <!--<div slot="right" class="float" :style="{top:fixHeight+'px'}" @click="iconAppear">-->
      <!--<div class="setIcon">-->
        <!--<img src="./imgs/set.png" alt width="40">-->
      <!--</div>-->
    <!--</div>-->
    ...
    <!--<div class="floatTop" :style="{top:fixHeight-128 +'px',display: iconIsAppear}">-->
      <!--<div class="icon" @click="onClickRight">-->
        <!--<img src="./imgs/create.png" alt width="40">-->
      <!--</div>-->
      <!--<div class="icon" @click="toFlashLetter2">-->
        <!--<img src="./imgs/message.png" alt width="40">-->
      <!--</div>-->
      <!--<div class="icon" @click="toFlashLetter1">-->
        <!--<img src="./imgs/flash.png" alt width="40">-->
      <!--</div>-->
    <!--</div>-->
  </div>
</template>
    ...
    create() {
      if (this.list.length > 0) {
        for (let key in this.list) {
          if (this.list[key].status_link === '计算中') {
            Dialog.alert({
              title: "提示",
