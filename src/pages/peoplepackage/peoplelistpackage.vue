<template>
  <div class="peoplelist">
    <van-row class="peoplelist-tab">
      <van-nav-bar :title="this.$route.meta.title" left-arrow @click-left="onClickLeft">
        <div class="buttons-wrap" slot="right">
          <span class="custom-btn" @click="deletethis">
            <van-icon name="delete"/>删除
          </span>
          <span class="custom-btn" @click="slideShow">
            <van-icon name="info-o"/>属性
          </span>
        </div>
      </van-nav-bar>
      <van-col span="24" style="border-bottom: 1px solid #ccc;background-color: #fff;">
        ...
        <!-- <van-col span="6" :class="{selecttab:slideshow}" style="text-align: center">
          <div v-on:click="slideShow">
            <div class="peoplelist-tab-title">属性</div>
            <div class="peoplelist-tab-num">7</div>
            <div>
              <div class="line-box" :class="{bgcolor:slideshow}"></div>
            </div>
          </div>
        </van-col>-->
      </van-col>
    ...
    <div class="showSelect">
      <van-popup v-model="showPopup" position="top" :overlay="true">
        <van-row>
          <van-col :span="24" style="text-align: center;font-size: 18px;padding: 20px 0;">标签属性</van-col>
          <van-col :span="24" class="pt5">
            <van-col :span="9" style="text-align:right;">
              <div class="bagDiv">人群包名称 :</div>
            </van-col>
            <van-col :span="15" style="text-align: left;">
              <div class="bagDiv">{{attribute.name}}</div>
            </van-col>
          </van-col>
          <van-col :span="24" class="pt5">
            <van-col :span="9" style="text-align:right">
              <div class="bagDiv">探知器 :</div>
            </van-col>
            <van-col :span="15" style="text-align: left;">
              <!--<div class="bagDiv">{{attribute.mid}}</div>-->
              <select
                name="bind"
                id="tanzhen"
                disabled
                v-model="bindSelect"
                style="text-algin:left;width: 90%;height:30px;border:none;background-color: #fff;"
              >
                <option value="all" class="bagDiv">全部探知器</option>
                <option
                  :value="items.number_id"
                  v-for="(items,index) in binding"
                  :key="index"
                >{{items.name}}</option>
              </select>
            </van-col>
          ...
          <van-col :span="24" class="pt5">
            <van-col :span="9" style="text-align:right">
              <div class="bagDiv">最短驻留时间(分) :</div>
            </van-col>
            <van-col :span="15" style="text-align: left;">
              <div class="bagDiv">{{attribute.min_time}}</div>
            </van-col>
          </van-col>
          <van-col :span="24" class="pt5">
            <van-col :span="9" style="text-align:right">
              <div class="bagDiv">最长驻留时间(分) :</div>
            </van-col>
            <van-col :span="15" style="text-align: left;">
              <div class="bagDiv">{{attribute.max_time}}</div>
            </van-col>
            <van-col :span="24" class="pt5">
              <van-col :span="9" style="text-align:right">
                <div class="bagDiv">筛选日期(起始) :</div>
              </van-col>
              <van-col :span="15" style="text-align: left;">
                <!--<div  class="bagDiv">{{// attribute.start_date}}</div>-->
                <div class="bagDiv">{{attribute.start_date}}</div>
              </van-col>
            </van-col>
            <van-col :span="24" class="pt5">
              <van-col :span="9" style="text-align:right">
                <div class="bagDiv">筛选日期(结束) :</div>
              </van-col>
              <van-col :span="15" style="text-align: left;">
                <!--<div class="bagDiv">{{// attribute.end_date}}</div>-->
                <div class="bagDiv">{{attribute.end_date}}</div>
              </van-col>
            </van-col>
          </van-col>
  ...
  methods: {
    ...
    confirmToTel() {
      ...
      setTimeout(() => {
        ...
        this.$router.push(
          "/peoplepackage/" + this.$route.params.id + "?id=&mac=" + this.mac
        );
      }, 500);
    },
    getBingding() {
